...
write.csv(pdata, file = "pdata.5hmC.integrated.csv")
...
save(bed.list, file="bed.list.5hmC.integrated.RData")



# inspection --------------------------------------------------------------

load("bed.list.5hmC.integrated.RData")
pdata <- read.csv("pdata.5hmC.integrated.csv", row.names = 1)
...
save(BSobj, file= "BSobj_5hmCpG_integrated.RData")
...
#  scale_color_manual(values = group.colors) +
  ggtitle("PCA 5hmC integrated data")
...
for(i in 1:nrow(regions)){
  ...
  plotDMRs(BSobj, regions=regions[i, ], testCovariate="group", addRegions = NULL, 
         main = paste0(rownames(regions)[i], " Targeted Region_5hmC"),
         extend = 0, annoTrack = annoTrack, highlightMain = F, qval = F, stat = F, horizLegend = T)
...
# DMK vs Treg
write.csv(dmls, file = "DMLs_5hmC_DMK.vs.Treg.csv")
# Treg vs tTreg
write.csv(dmls, file = "DMLs_5hmC_Treg.vs.tTreg.csv")
# Treg vs Th0
write.csv(dmls, file = "DMLs_5hmC_Treg.vs.Th0.csv")
# Th1 vs Th0
write.csv(dmls, file = "DMLs_5hmC_Th1.vs.Th0.csv")
# Th2 vs Th0
write.csv(dmls, file = "DMLs_5hmC_Th2.vs.Th0.csv")
write.csv(dmrs, file = "DMRs_5hmC_Th2.vs.Th0.csv")
# Th17 vs Th0
write.csv(dmls, file = "DMLs_5hmC_Th17.vs.Th0.csv")
# Th17.no.TGFb vs Th17
write.csv(dmls, file = "DMLs_5hmC_Th17.no.TGFb.vs.Th17.csv")
# Th17.TGFb.KO vs Th17.TGFb.WT
write.csv(dmls, file = "DMLs_5hmC_Th17.KO.vs.WT.csv")
