...
# TcellID nanopore runs until April 2022

#######################################################

#######################################################
# re-basecalled with megalodon + remora model (5mC_5hmC, CpG context)
#######################################################
...
# selected runs for Valerie's paper corresponding to two experiments, CAR157 and CAR158:
...
# why the same sample with two barcodes?
#20210324
Crispr targeted LIGATION sequencing SQK-LSK109
EXP-NBD104
